...
//$_rbox_$_modify_$_lijiehong_$_begin_$ don't hide statusbar in launcher2
        /*Log.d(TAG,"send boardcast("+SYSTEMUI_DISABLE_HIDEBAR_ACTION+") from launcher2..");
        Intent i = new Intent();
        i.setAction(SYSTEMUI_DISABLE_HIDEBAR_ACTION);
        sendBroadcast(i);*/
//$_rbox_$_modify_$_lijiehong_$_end_$ don't hide statusbar in launcher2
        super.onResume();
...
//$_rbox_$_modify_$_lijiehong_$_begin_$ don't hide statusbar in launcher2
    public static String SYSTEMUI_ENABLE_HIDEBAR_ACTION = "com.android.systembar.enable_hide";
    public static String SYSTEMUI_DISABLE_HIDEBAR_ACTION = "com.android.systembar.disable_hide";
	
    @Override
    protected void onPause() {
        /*Log.d(TAG,"send boardcast("+SYSTEMUI_ENABLE_HIDEBAR_ACTION+") from launcher2..");
        Intent i = new Intent();
        i.setAction(SYSTEMUI_ENABLE_HIDEBAR_ACTION);
        sendBroadcast(i);*/
//$_rbox_$_modify_$_lijiehong_$_begin_$ don't hide statusbar in launcher2
    ...
    */
    ...
    //$_rbox_$_modify_$_chenxiao_$_begin
    private final String ACTION_DISABLE_WALLPAPER = "com.android.disablewallpaper";
    private boolean showWallpaper = true;
    private final BroadcastReceiver mDisWallpaperReceiver = new BroadcastReceiver() {
         @Override
         public void onReceive(Context context, Intent intent) {
        	 final String action = intent.getAction();
        	 Log.d(TAG,"get broadcast action = "+action+",isAllAppsViible ="+isAllAppsVisible());
        	 if (ACTION_DISABLE_WALLPAPER.equals(action)) {
        		 if (isAllAppsVisible()) {
        			 showWallpaper = false;
        			 updateWallpaperVisibility(false);
        		 } else {
    ...
    public void onAttachedToWindow() {
        ...
        //$_rbox_$_modify_$_chenxiao_$_begin
        final IntentFilter diswallpaperfilter = new IntentFilter(ACTION_DISABLE_WALLPAPER);
        registerReceiver(mDisWallpaperReceiver, diswallpaperfilter);
        //$_rbox_$_modify_$_chenxiao_$_end
    ...
    public void onDetachedFromWindow() {
        ...
        if (mAttached) {
            ...
            //$_rbox_$_modify_$_chenxiao_$_begin
            unregisterReceiver(mDisWallpaperReceiver);
            //$_rbox_$_modify_$_chenxiao_$_end
            mAttached = false;
        }
        updateRunning();
