...
/*
		...
		else 
		{
			...
			else if (mConfig != null) 
			{
                status = mContext.getString((mConfig.status == WifiConfiguration.Status.DISABLED) ?
                        R.string.disabled : R.string.wifi_remembered);
            }
			...
			else 
			{
                String format = mContext.getString((status == null) ?
                        R.string.wifi_secured_first_item : R.string.wifi_secured_second_item);
                String[] type = mContext.getResources().getStringArray(R.array.wifi_security);
                return String.format(format, type[security], status);
            }
        }
	}*/
	...
	public String getStatus()
	{
		...
		{ 
			if (mConfig != null) { // Is saved network
				return mContext.getString(R.string.wifi_remembered);
			}
		}
  		return null;
	}
...
*/	
	...
	public void setCallBack(WifiUICallBack callback)
	{
		mCallBack = callback;
	}
