package com.rk.setting.wifi.android_4_0_3;
...
/*		
		for (Access_Point accessPoint : accessPoints) {
			...
			Log.d("WifiSetting","Access Point ssid is :::::::::::::::::"+accessPoint.ssid+",level = "+accessPoint.getLevel());
		}*/
	...
	private void connect(int networkId) {
        ...
        if (mLastPriority > 1000000) {/*
            for (int i = mAccessPoints.getPreferenceCount() - 1; i >= 0; --i) {
                Access_Point accessPoint = (Access_Point) mAccessPoints.getPreference(i);
	...
	public void onClick(DialogInterface dialogInterface, int button) {
		Log.d("WifiSetting","onClick()***************,button = "+button);
        if (button == Wifi_Dialog.BUTTON_FORGET && mSelected != null) {
		    ...
		    String pin_code = mWifiManager.startPIN(mSelected.bssid);
                    Log.d(TAG, "bssid=" + mSelected.bssid + " pin_code=" + pin_code);
                    if (pin_code != null) {
