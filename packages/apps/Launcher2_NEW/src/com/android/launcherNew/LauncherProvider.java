...
import com.android.launcherNew.LauncherSettings.Favorites;
...
public class LauncherProvider extends ContentProvider {
    ...
    static final String AUTHORITY = "com.android.launcherNew.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // - Passion shipped on 2.1 with version 6 of launcherNew
        ...
        private boolean updateContactsShortcuts(SQLiteDatabase db) {
            ...
            try {
                ...
                while (c != null && c.moveToNext()) {
				    ...
				    intent.putExtra(Launcher.INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION, true);
