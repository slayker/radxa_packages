...
import com.rockchip.settings.dialog.ApplicationsState.AppEntry;
 ...
 */
   ...
   public  class ManageApplications extends AlertActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		} else if (intent.getComponent().getClassName().equals("com.android.settings.applications.StorageUse")
		...
		View Downloaded = flater.inflate(R.layout.setting_tab_downloaded, null);
		View All = flater.inflate(R.layout.setting_tab_all, null);
		View SDcard = flater.inflate(R.layout.setting_tab_sdcard, null);
		View Running = flater.inflate(R.layout.setting_tab_running, null);
