...
public class TtsEnginePreference extends Preference {
	...
	/**
	 * Key for the name of the TTS engine passed in to the engine settings
	 * fragment {@link TtsEngineSettingsFragment}.
	 */
	static final String FRAGMENT_ARGS_NAME = "name";

	/**
	 * Key for the label of the TTS engine passed in to the engine settings
	 * fragment. This is used as the title of the fragment
	 * {@link TtsEngineSettingsFragment}.
	 */
	static final String FRAGMENT_ARGS_LABEL = "label";

	/**
	 * Key for the voice data data passed in to the engine settings fragmetn
	 * {@link TtsEngineSettingsFragment}.
	 */
	static final String FRAGMENT_ARGS_VOICES = "voices";

	/**
	 * The preference activity that owns this preference. Required for
	 * instantiating the engine specific settings screen.
	 */
	...
	/**
	 * When true, the change callbacks on the radio button will not fire.
	 */
	...
	public TtsEnginePreference(Context context, EngineInfo info,
			RadioButtonGroupState state, PreferenceActivity prefActivity) {
		super(context);
	...
	public View getView(View convertView, ViewGroup parent) {
		if (mSharedState == null) {
			throw new IllegalStateException(
					"Call to getView() before a call to" + "setSharedState()");
		}

		View view = super.getView(convertView, parent);
		final RadioButton rb = (RadioButton) view
				.findViewById(R.id.tts_engine_radiobutton);
	...
	private void onRadioButtonClicked(CompoundButton buttonView,
			boolean isChecked) {
	...
	/**
	 * Holds all state that is common to this group of radio buttons, such as
	 * the currently selected key and the currently checked compound button.
