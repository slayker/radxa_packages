...
package com.rockchip.settings.privacy.ice_cream;
...
/*$_rbox_$_modify_$protected void onCreate(Bundle icicle)*/
/*$_rbox_$_modify_$_lijiehong_$_20120319_$*/
    @Override
    protected void onCreate(Bundle icicle) {
        ...
        //disable preference item if needed. add by ljh
        checkDisabledItems();
    }

    private final String TAG = "StatusInfo";
/*$_rbox_$_modify_$private void checkDisabledItems()*/
/*$_rbox_$_modify_$_lijiehong_$_20120319_$*/
    private void checkDisabledItems(){//check from global config.xml .add by ljh
        Log.d(TAG,"------------------check disabled items--------------");
        if(findPreference(KEY_BATTERY_STATUS)!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableBatteryStatusPreference) == false) {
            Log.d(TAG,"---removing "+KEY_BATTERY_STATUS);
            removePreferenceFromScreen(KEY_BATTERY_STATUS);
        }
        if(findPreference(KEY_BATTERY_LEVEL)!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableBatteryLevelPreference) == false) {
            Log.d(TAG,"---removing "+KEY_BATTERY_LEVEL);
            removePreferenceFromScreen(KEY_BATTERY_LEVEL);
        }
        if(findPreference(KEY_IP_ADDRESS)!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableIpAddressPreference) == false) {
            Log.d(TAG,"---removing "+KEY_IP_ADDRESS);
            removePreferenceFromScreen(KEY_IP_ADDRESS);
        }
        if(findPreference(KEY_WIFI_MAC_ADDRESS)!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableWifiMacAddressPreference) == false) {
            Log.d(TAG,"---removing "+KEY_WIFI_MAC_ADDRESS);
            removePreferenceFromScreen(KEY_WIFI_MAC_ADDRESS);
        }
        if(findPreference(KEY_BT_ADDRESS)!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableBtAddressPreference) == false) {
            Log.d(TAG,"---removing "+KEY_BT_ADDRESS);
            removePreferenceFromScreen(KEY_BT_ADDRESS);
        }
        if(findPreference(KEY_SERIAL_NUMBER)!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableSerialNumberPreference) == false) {
            Log.d(TAG,"---removing "+KEY_SERIAL_NUMBER);
            removePreferenceFromScreen(KEY_SERIAL_NUMBER);
        }
        if(findPreference("up_time")!=null && getResources().getBoolean(
                        com.android.internal.R.bool.config_enableUpTimePreference) == false) {
            Log.d(TAG,"---removing "+"up_time");
