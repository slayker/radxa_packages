...
//$_rbox_$_modify_$_chenzhi: remove "Screen lock sound" && "Vibrate on touch"
...
//$_rbox_$_modify_$_end
		...
		mSoundDevices = mSoundSettings.findPreference(KEY_SOUND_DEVICES);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
		...
		/*$_rbox_$_modify_$_zhangxueguang_$_begin_$_20120319_$*/	
        } else if (preference == mSoundDevices) {
            // let the framework fire off the intent
            return false;
		}
		/*$_rbox_$_modify_$_zhangxueguang_$_end_$_20120319_$*/	
