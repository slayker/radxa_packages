...
public class MediaScannerService extends Service implements Runnable
{
    ...
    private final class ServiceHandler extends Handler
    {
        ...
        public void handleMessage(Message msg)
        {
			...
			//TODO: fixme, liuji, move hardcode string to common globle in this code block
/* $_rbox_$_modify_$ begin*/		
/* $_rbox_$_modify_$_huangyonglin: added for no repeating scan 2012-07-02 */						
/* $_rbox_$_modify_$_huangyonglin: added for speeding up the media updating 2012-03-31 */			
			if (path == null) {
                          directories = mExternalStoragePaths;
			} else if (path.startsWith("/mnt/usb_storage")) {
				directories = new String[] {path};//{"/mnt/usb_storage"};
			} else {
				if (path.startsWith("/mnt/sdcard") ||path.startsWith("/mnt/external_sd"))
					directories = new String[] {path};
				else
					directories = new String[] {"/mnt/sdcard", "/mnt/external_sd"};
			}
                    }
