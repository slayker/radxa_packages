...
// $_rbox_$_modify_$_lijiehong:_begin_$ add by lijiehong for supporting the remote controller
    @Override
...
//$_rbox_$_modify_$_lijiehong:_begin_$ changed by lijiehong to support configure more keys panel
    private void showSubtypeSelectorAndSettings() {
        ...
        final CharSequence[] items = new CharSequence[] {
                ...
                getString(R.string.more_keys_panel_settings),//add by lijiehong
        };
        ...
        final DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface di, int position) {
                ...
                case 1:
                    launchSettings();
                    break;
                case 2://add by lijiehong
                    final boolean enabled = Settings.isMoreKeysPanelEnabled(mPrefs,mResources);
                    String title = null;
                    if(enabled)
                        title = mResources.getString(R.string.disable_more_keys_panel);
                    else
                        title = mResources.getString(R.string.show_more_keys_panel);
                    final AlertDialog.Builder builder = new AlertDialog.Builder(context)
                            .setTitle(title)
                            .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener(){
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                                    mPrefs.edit().putBoolean(Settings.PREF_SHOW_MORE_KEYS_PANEL, !enabled).apply();
                                }
                            })
