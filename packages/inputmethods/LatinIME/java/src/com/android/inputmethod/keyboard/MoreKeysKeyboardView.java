...
//$_rbox_$_modify_$_lijiehong: begin add by lijiehong for caculating scale
    public int getKeyboardWidth(){
        final Keyboard keyboard = getKeyboard();
        int width = 0;
        if (keyboard != null) {
            width = keyboard.mOccupiedWidth + getPaddingLeft() + getPaddingRight();
        }
        return width;
    }
    ...
    public int getKeyboardHeight(){
        ...
        int height = 0;
        if (keyboard != null) {
            height = keyboard.mOccupiedHeight + getPaddingTop() + getPaddingBottom();
        }
        return height;
    }

    public int getKeyHeightWithGap(){
        final Keyboard keyboard = getKeyboard();
        int width = 0;
        if (keyboard != null) {
            width = keyboard.mVerticalGap + keyboard.mMostCommonKeyHeight;
        }
        return width;
    }

    public int getKeyWidthWithGap(){
        final Keyboard keyboard = getKeyboard();
        int height = 0;
        if (keyboard != null) {
          height = keyboard.mHorizontalGap + keyboard.mMostCommonKeyWidth;
        }
        return height;
    }
//$_rbox_$_modify_$_lijiehong: end add by lijiehong for caculating scale
